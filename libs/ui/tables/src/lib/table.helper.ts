import {ProblemTable, RowDefs, SideTable} from '@opres/shared/types';
...
export function tableSourceFrom(rows: number, rowDefinitions: RowDefs): ProblemTable | SideTable {
